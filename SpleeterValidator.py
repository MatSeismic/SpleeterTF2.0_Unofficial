...
#This file would use the output from the npy file as predicted value and generate the audio file with only vocal portion of 'A ClassicEducation' song
predValuesFromOfficialSpleeter = np.load('PredictionsFromOfficialSpleeter/AClassicEducationVocal.npy', allow_pickle=True)

sampleRunToValidateProcessingFlag = False
...
def separate(waveform, audio_descriptor):
    ...
    save_to_file(out, audio_descriptor, output_destination,
